...
func newCache(conf *CacheConfig) (c *CacheDefault, err error) {
	c = &CacheDefault{
...
func (c *CacheDefault) Update(key cacheRegistry, v interface{}) (err error) {
	if v == nil {
...
//  	// add the new user. See CacheDefault.Update
//  }
//
// TODO-optimize: for bulk changes
func (c *CacheDefault) DirectUpdate(registry cacheRegistry, id Snowflake, changes []byte) error {
	switch registry {
	case UserCache:
...
func (c *CacheDefault) Get(key cacheRegistry, id Snowflake, args ...interface{}) (v interface{}, err error) {
	switch key {
	case UserCache:
		v, err = c.GetUser(id)
	case VoiceStateCache:
...
func (g *guildCacheItem) build(cache *CacheDefault) (guild *Guild) {
	var err error
...
func (c *CacheDefault) SetGuild(guild *Guild) {
...
func (c *CacheDefault) SetGuildEmojis(guildID Snowflake, emojis []*Emoji) {
	if c.guilds == nil {
		return
	}
...
func (c *CacheDefault) SetGuildMember(guildID Snowflake, member *Member) {
...
func (c *CacheDefault) SetGuildMembers(guildID Snowflake, members []*Member) {
...
func (c *CacheDefault) SetGuildRoles(guildID Snowflake, roles []*Role) {
...
func (c *CacheDefault) UpdateMemberAndUser(guildID, userID Snowflake, data json.RawMessage) {
	var tmpUser = &User{
		ID: userID,
	}
	var member *Member
...
func (c *CacheDefault) AddGuildMember(guildID Snowflake, member *Member) {
...
func (c *CacheDefault) RemoveGuildMember(guildID Snowflake, memberID Snowflake) {
	guild, err := c.PeekGuild(guildID)
	if err != nil {
		return
	}
...
// GetGuild ...
func (c *CacheDefault) GetGuild(id Snowflake) (guild *Guild, err error) {
	if c.guilds == nil {
...
func (c *CacheDefault) PeekGuild(id Snowflake) (*Guild, error) {
...
func (c *CacheDefault) PeekGuildHolder(id Snowflake) (guild *guildCacheItem, err error) {
	if c.guilds == nil {
		err = newErrorUsingDeactivatedCache("guilds")
		return
	}
...
// GetGuildRoles ...
func (c *CacheDefault) GetGuildRoles(id Snowflake) (roles []*Role, err error) {
	if c.guilds == nil {
		err = newErrorUsingDeactivatedCache("guilds")
		return
	}
...
// GetGuildRoles ...
func (c *CacheDefault) GetGuildEmojis(id Snowflake) (emojis []*Emoji, err error) {
	if c.guilds == nil {
		err = newErrorUsingDeactivatedCache("guilds")
		return
	}
...
// complexity: O(M * N)
func (c *CacheDefault) UpdateOrAddGuildMembers(guildID Snowflake, members []*Member) {
...
// GetGuildMember ...
func (c *CacheDefault) GetGuildMember(guildID, userID Snowflake) (member *Member, err error) {
	if c.guilds == nil {
		err = newErrorUsingDeactivatedCache("guilds")
		return
	}
...
func (c *CacheDefault) GetGuildMembersAfter(guildID, after Snowflake, limit int) (members []*Member, err error) {
	if c.guilds == nil {
		err = newErrorUsingDeactivatedCache("guilds")
		return
	}
...
// DeleteGuild ...
func (c *CacheDefault) DeleteGuild(id Snowflake) {
	if c.guilds == nil {
		return
	}
...
func (c *CacheDefault) DeleteGuildChannel(guildID, channelID Snowflake) {
	if c.guilds == nil {
		return
	}
...
func (c *CacheDefault) DeleteGuildEmoji(guildID, emojiID Snowflake) {
	if c.guilds == nil {
		return
	}
...
func (c *CacheDefault) AddGuildRole(guildID Snowflake, role *Role) {
	if c.guilds == nil {
		return
	}
...
func (c *CacheDefault) UpdateGuildRole(guildID Snowflake, role *Role, data json.RawMessage) bool {
	if c.guilds == nil {
		return false
	}
...
func (c *CacheDefault) AddGuildChannel(guildID Snowflake, channelID Snowflake) {
	if c.guilds == nil {
		return
	}
...
func (c *CacheDefault) DeleteGuildRole(guildID, roleID Snowflake) {
	if c.guilds == nil {
		return
	}
...
func (c *CacheDefault) SetUser(new *User) {
...
// GetUser ...
func (c *CacheDefault) GetUser(id Snowflake) (user *User, err error) {
	if c.users == nil {
...
func (c *CacheDefault) PeekUser(id Snowflake) (*User, error) {
	if c.users == nil {
...
func (c *CacheDefault) SetVoiceState(state *VoiceState) {
...
// GetVoiceState ...
func (c *CacheDefault) GetVoiceState(guildID Snowflake, params *guildVoiceStateCacheParams) (state *VoiceState, err error) {
...
func (c *channelCacheItem) build(cache *CacheDefault) (channel *Channel) {
	if cache.immutable {
...
func (c *CacheDefault) SetChannel(new *Channel) {
...
// UpdateChannelPin ...
func (c *CacheDefault) UpdateChannelPin(id Snowflake, timestamp Time) {
...
func (c *CacheDefault) UpdateChannelLastMessageID(channelID Snowflake, messageID Snowflake) {
...
// GetChannel ...
func (c *CacheDefault) GetChannel(id Snowflake) (channel *Channel, err error) {
	if c.channels == nil {
...
// DeleteChannel ...
func (c *CacheDefault) DeleteChannel(id Snowflake) {
	c.channels.Lock()
	defer c.channels.Unlock()
...
func (c *CacheDefault) DeleteChannelPermissionOverwrite(channelID Snowflake, overwriteID Snowflake) error {
	if c.channels == nil {
